...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "track_line_filter",
        "sources": [
            "track_line_filter.pyx"
        ]
    },
    "module_name": "track_line_filter"
}
END: Cython Metadata */
...
#define __PYX_HAVE__track_line_filter
#define __PYX_HAVE_API__track_line_filter
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'track_line_filter' */
...
#define __Pyx_MODULE_NAME "track_line_filter"
extern int __pyx_module_is_main_track_line_filter;
int __pyx_module_is_main_track_line_filter = 0;

/* Implementation of 'track_line_filter' */
...
static const char __pyx_k_edges_frame[] = "edges_frame";
...
static PyObject *__pyx_n_s_edges_frame;
...
static PyObject *__pyx_pf_17track_line_filter_find_lines(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_edges_frame, int __pyx_v_threshold, float __pyx_v_tolerance, int __pyx_v_cut); /* proto */
...
static __Pyx_memviewslice __pyx_f_17track_line_filter_find_lines(__Pyx_memviewslice __pyx_v_edges_frame, int __pyx_v_threshold, float __pyx_v_tolerance, int __pyx_v_cut, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_v_y_size;
  int __pyx_v_x_size;
  PyObject *__pyx_v_eval_frames = NULL;
  __Pyx_memviewslice __pyx_v_f = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_row_sum = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_column_sum = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_rows = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_columns = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_i;
  int __pyx_v_c;
  int __pyx_v_row;
  int __pyx_v_column;
 ...
 */
  __pyx_t_1.data = __pyx_v_edges_frame.data;
  __pyx_t_1.memview = __pyx_v_edges_frame.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_1, 0);
  __pyx_t_2 = -1;
  if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_1,
    __pyx_v_edges_frame.shape[0], __pyx_v_edges_frame.strides[0], __pyx_v_edges_frame.suboffsets[0],
    0,
    0,
    &__pyx_t_2,
    __pyx_v_cut,
...
__pyx_t_1.shape[1] = __pyx_v_edges_frame.shape[1];
__pyx_t_1.strides[1] = __pyx_v_edges_frame.strides[1];
    __pyx_t_1.suboffsets[1] = -1;

__pyx_v_cut_frame = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "track_line_filter.pyx":13
 * 
 *     # Lower values in cut_frame
 *     cdef int x, y = 0             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_3 = __Pyx_MemoryView_Len(__pyx_v_cut_frame); 
  __pyx_v_y_size = __pyx_t_3;

  /* "track_line_filter.pyx":15
 *     cdef int x, y = 0
 *     cdef int y_size = len(cut_frame)
 *     cdef int x_size = len(cut_frame[0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_4.data = __pyx_v_cut_frame.data;
  __pyx_t_4.memview = __pyx_v_cut_frame.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_4, 0);
  {
    Py_ssize_t __pyx_tmp_idx = 0;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_cut_frame.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_cut_frame.strides[0];
        if (__pyx_tmp_idx < 0)
...
__pyx_t_4.shape[0] = __pyx_v_cut_frame.shape[1];
__pyx_t_4.strides[0] = __pyx_v_cut_frame.strides[1];
    __pyx_t_4.suboffsets[0] = -1;

__pyx_t_3 = __Pyx_MemoryView_Len(__pyx_t_4); 
  __PYX_XDEC_MEMVIEW(&__pyx_t_4, 1);
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;
  __pyx_v_x_size = __pyx_t_3;

  /* "track_line_filter.pyx":17
 *     cdef int x_size = len(cut_frame[0])
 * 
 *     for x in range(0, x_size):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_12 = -1;
      if (__pyx_t_10 < 0) {
        __pyx_t_10 += __pyx_v_cut_frame.shape[0];
        if (unlikely(__pyx_t_10 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_10 >= __pyx_v_cut_frame.shape[0])) __pyx_t_12 = 0;
      if (__pyx_t_11 < 0) {
        __pyx_t_11 += __pyx_v_cut_frame.shape[1];
        if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 1;
      } else if (unlikely(__pyx_t_11 >= __pyx_v_cut_frame.shape[1])) __pyx_t_12 = 1;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 19, __pyx_L1_error)
      }
      __pyx_t_13 = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_cut_frame.data + __pyx_t_10 * __pyx_v_cut_frame.strides[0]) ) + __pyx_t_11 * __pyx_v_cut_frame.strides[1]) ))) == 0xFF) != 0);
      if (__pyx_t_13) {

        /* "track_line_filter.pyx":20
 *         for y in range(0, y_size):
 *             if cut_frame[y][x] == 255:
 *                 cut_frame[y][x] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_12 = -1;
        if (__pyx_t_14 < 0) {
          __pyx_t_14 += __pyx_v_cut_frame.shape[0];
          if (unlikely(__pyx_t_14 < 0)) __pyx_t_12 = 0;
        } else if (unlikely(__pyx_t_14 >= __pyx_v_cut_frame.shape[0])) __pyx_t_12 = 0;
        if (__pyx_t_15 < 0) {
          __pyx_t_15 += __pyx_v_cut_frame.shape[1];
          if (unlikely(__pyx_t_15 < 0)) __pyx_t_12 = 1;
        } else if (unlikely(__pyx_t_15 >= __pyx_v_cut_frame.shape[1])) __pyx_t_12 = 1;
        if (unlikely(__pyx_t_12 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_12);
          __PYX_ERR(0, 20, __pyx_L1_error)
        }
        *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_cut_frame.data + __pyx_t_14 * __pyx_v_cut_frame.strides[0]) ) + __pyx_t_15 * __pyx_v_cut_frame.strides[1]) )) = 1;
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_17, __pyx_n_s_np); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __pyx_t_18 = __Pyx_PyObject_GetAttrStr(__pyx_t_17, __pyx_n_s_hsplit); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __pyx_t_17 = __pyx_memoryview_fromslice(__pyx_v_cut_frame, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  if (unlikely(__pyx_v_threshold == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 23, __pyx_L1_error)
  }
  __pyx_t_19 = PyFloat_FromDouble((((double)__pyx_v_x_size) / ((double)__pyx_v_threshold))); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 23, __pyx_L1_error)
  ...
  if (PyFunction_Check(__pyx_t_18)) {
    ...
    __pyx_t_16 = __Pyx_PyFunction_FastCall(__pyx_t_18, __pyx_temp+1-__pyx_t_2, 2+__pyx_t_2); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 23, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_18)) {
    PyObject *__pyx_temp[3] = {__pyx_t_20, __pyx_t_17, __pyx_t_19};
    __pyx_t_16 = __Pyx_PyCFunction_FastCall(__pyx_t_18, __pyx_temp+1-__pyx_t_2, 2+__pyx_t_2); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_20); __pyx_t_20 = 0;
    __Pyx_GOTREF(__pyx_t_16);
    __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
    __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
  ...
  #endif
  {
    __pyx_t_21 = PyTuple_New(2+__pyx_t_2); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_21);
    if (__pyx_t_20) {
      __Pyx_GIVEREF(__pyx_t_20); PyTuple_SET_ITEM(__pyx_t_21, 0, __pyx_t_20); __pyx_t_20 = NULL;
    }
    __Pyx_GIVEREF(__pyx_t_17);
    PyTuple_SET_ITEM(__pyx_t_21, 0+__pyx_t_2, __pyx_t_17);
    __Pyx_GIVEREF(__pyx_t_19);
    PyTuple_SET_ITEM(__pyx_t_21, 1+__pyx_t_2, __pyx_t_19);
    __pyx_t_17 = 0;
    __pyx_t_19 = 0;
    __pyx_t_16 = __Pyx_PyObject_Call(__pyx_t_18, __pyx_t_21, NULL); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  }
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __pyx_v_eval_frames = __pyx_t_16;
  __pyx_t_16 = 0;

  /* "track_line_filter.pyx":26
 * 
 *     # Declare C variables type
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_16, __pyx_n_s_np); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __pyx_t_18 = __Pyx_PyObject_GetAttrStr(__pyx_t_16, __pyx_n_s_zeros); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  __pyx_t_16 = __Pyx_PyInt_From_int(__pyx_v_threshold); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __pyx_t_21 = __Pyx_PyInt_From_int(__pyx_v_y_size); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_21);
  __pyx_t_19 = PyTuple_New(2); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  ...
  __pyx_t_16 = 0;
  __pyx_t_21 = 0;
  __pyx_t_21 = PyTuple_New(1); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_21);
  __Pyx_GIVEREF(__pyx_t_19);
  PyTuple_SET_ITEM(__pyx_t_21, 0, __pyx_t_19);
  __pyx_t_19 = 0;
  __pyx_t_19 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __Pyx_GetModuleGlobalName(__pyx_t_16, __pyx_n_s_np); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __pyx_t_17 = __Pyx_PyObject_GetAttrStr(__pyx_t_16, __pyx_n_s_ubyte); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  if (PyDict_SetItem(__pyx_t_19, __pyx_n_s_dtype, __pyx_t_17) < 0) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __pyx_t_17 = __Pyx_PyObject_Call(__pyx_t_18, __pyx_t_21, __pyx_t_19); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_t_17, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __pyx_v_f = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "track_line_filter.pyx":28
 *     cdef unsigned char[:,:] f = np.zeros((threshold, y_size), dtype=np.ubyte)
 * 
 *     cdef float[:] row_sum = np.zeros(y_size, dtype=np.float32)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_17);
  __pyx_t_19 = __Pyx_PyObject_GetAttrStr(__pyx_t_17, __pyx_n_s_zeros); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __pyx_t_17 = __Pyx_PyInt_From_int(__pyx_v_y_size); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __pyx_t_21 = PyTuple_New(1); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_21);
  __Pyx_GIVEREF(__pyx_t_17);
  PyTuple_SET_ITEM(__pyx_t_21, 0, __pyx_t_17);
  __pyx_t_17 = 0;
  __pyx_t_17 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __Pyx_GetModuleGlobalName(__pyx_t_18, __pyx_n_s_np); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __pyx_t_16 = __Pyx_PyObject_GetAttrStr(__pyx_t_18, __pyx_n_s_float32); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  if (PyDict_SetItem(__pyx_t_17, __pyx_n_s_dtype, __pyx_t_16) < 0) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  __pyx_t_16 = __Pyx_PyObject_Call(__pyx_t_19, __pyx_t_21, __pyx_t_17); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
  __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __pyx_t_22 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_16, PyBUF_WRITABLE); if (unlikely(!__pyx_t_22.memview)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  __pyx_v_row_sum = __pyx_t_22;
  __pyx_t_22.memview = NULL;
  __pyx_t_22.data = NULL;

  /* "track_line_filter.pyx":29
 * 
 *     cdef float[:] row_sum = np.zeros(y_size, dtype=np.float32)
 *     cdef float[:] column_sum = np.zeros(threshold, dtype=np.float32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_16);
  __pyx_t_17 = __Pyx_PyObject_GetAttrStr(__pyx_t_16, __pyx_n_s_zeros); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  __pyx_t_16 = __Pyx_PyInt_From_int(__pyx_v_threshold); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __pyx_t_21 = PyTuple_New(1); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_21);
  __Pyx_GIVEREF(__pyx_t_16);
  PyTuple_SET_ITEM(__pyx_t_21, 0, __pyx_t_16);
  __pyx_t_16 = 0;
  __pyx_t_16 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __Pyx_GetModuleGlobalName(__pyx_t_19, __pyx_n_s_np); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __pyx_t_18 = __Pyx_PyObject_GetAttrStr(__pyx_t_19, __pyx_n_s_float32); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
  if (PyDict_SetItem(__pyx_t_16, __pyx_n_s_dtype, __pyx_t_18) < 0) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __pyx_t_18 = __Pyx_PyObject_Call(__pyx_t_17, __pyx_t_21, __pyx_t_16); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  __pyx_t_22 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_18, PyBUF_WRITABLE); if (unlikely(!__pyx_t_22.memview)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __pyx_v_column_sum = __pyx_t_22;
  __pyx_t_22.memview = NULL;
  __pyx_t_22.data = NULL;

  /* "track_line_filter.pyx":31
 *     cdef float[:] column_sum = np.zeros(threshold, dtype=np.float32)
 * 
 *     cdef unsigned char[:] rows = np.zeros(threshold, dtype=np.ubyte)             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __Pyx_GetModuleGlobalName(__pyx_t_18, __pyx_n_s_np); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __pyx_t_16 = __Pyx_PyObject_GetAttrStr(__pyx_t_18, __pyx_n_s_zeros); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __pyx_t_18 = __Pyx_PyInt_From_int(__pyx_v_threshold); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __pyx_t_21 = PyTuple_New(1); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_21);
  __Pyx_GIVEREF(__pyx_t_18);
  PyTuple_SET_ITEM(__pyx_t_21, 0, __pyx_t_18);
  __pyx_t_18 = 0;
  __pyx_t_18 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __Pyx_GetModuleGlobalName(__pyx_t_17, __pyx_n_s_np); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __pyx_t_19 = __Pyx_PyObject_GetAttrStr(__pyx_t_17, __pyx_n_s_ubyte); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  if (PyDict_SetItem(__pyx_t_18, __pyx_n_s_dtype, __pyx_t_19) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
  __pyx_t_19 = __Pyx_PyObject_Call(__pyx_t_16, __pyx_t_21, __pyx_t_18); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_char(__pyx_t_19, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
  __pyx_v_rows = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "track_line_filter.pyx":32
 * 
 *     cdef unsigned char[:] rows = np.zeros(threshold, dtype=np.ubyte)
 *     cdef unsigned char[:] columns = np.zeros(y_size, dtype=np.ubyte)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_19, __pyx_n_s_np); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __pyx_t_18 = __Pyx_PyObject_GetAttrStr(__pyx_t_19, __pyx_n_s_zeros); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
  __pyx_t_19 = __Pyx_PyInt_From_int(__pyx_v_y_size); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __pyx_t_21 = PyTuple_New(1); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_21);
  __Pyx_GIVEREF(__pyx_t_19);
  PyTuple_SET_ITEM(__pyx_t_21, 0, __pyx_t_19);
  __pyx_t_19 = 0;
  __pyx_t_19 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_19);
  __Pyx_GetModuleGlobalName(__pyx_t_16, __pyx_n_s_np); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __pyx_t_17 = __Pyx_PyObject_GetAttrStr(__pyx_t_16, __pyx_n_s_ubyte); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  if (PyDict_SetItem(__pyx_t_19, __pyx_n_s_dtype, __pyx_t_17) < 0) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __pyx_t_17 = __Pyx_PyObject_Call(__pyx_t_18, __pyx_t_21, __pyx_t_19); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
  __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_char(__pyx_t_17, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __pyx_v_columns = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "track_line_filter.pyx":34
 *     cdef unsigned char[:] columns = np.zeros(y_size, dtype=np.ubyte)
 * 
 *     cdef int i, c, row, column, general_column, correction = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_17 = PyList_New(0); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __pyx_v_points = ((PyObject*)__pyx_t_17);
  __pyx_t_17 = 0;

  /* "track_line_filter.pyx":39
 * 
 *     # Evaluate image in segments
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_eval_frames)) || PyTuple_CheckExact(__pyx_v_eval_frames)) {
    __pyx_t_17 = __pyx_v_eval_frames; __Pyx_INCREF(__pyx_t_17); __pyx_t_23 = 0;
    __pyx_t_24 = NULL;
  } else {
    __pyx_t_23 = -1; __pyx_t_17 = PyObject_GetIter(__pyx_v_eval_frames); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_17);
    __pyx_t_24 = Py_TYPE(__pyx_t_17)->tp_iternext; if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 39, __pyx_L1_error)
  }
  for (;;) {
    if (likely(!__pyx_t_24)) {
      if (likely(PyList_CheckExact(__pyx_t_17))) {
        ...
        __pyx_t_19 = PyList_GET_ITEM(__pyx_t_17, __pyx_t_23); __Pyx_INCREF(__pyx_t_19); __pyx_t_23++; if (unlikely(0 < 0)) __PYX_ERR(0, 39, __pyx_L1_error)
        #else
        __pyx_t_19 = PySequence_ITEM(__pyx_t_17, __pyx_t_23); __pyx_t_23++; if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_19);
        #endif
      } else {
        if (__pyx_t_23 >= PyTuple_GET_SIZE(__pyx_t_17)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_19 = PyTuple_GET_ITEM(__pyx_t_17, __pyx_t_23); __Pyx_INCREF(__pyx_t_19); __pyx_t_23++; if (unlikely(0 < 0)) __PYX_ERR(0, 39, __pyx_L1_error)
        #else
        __pyx_t_19 = PySequence_ITEM(__pyx_t_17, __pyx_t_23); __pyx_t_23++; if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_19);
        #endif
      ...
      __pyx_t_19 = __pyx_t_24(__pyx_t_17);
    ...
    __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_t_19, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
 ...
 * 
 */
    __pyx_v_correction = (__pyx_v_threshold * __pyx_v_i);

    /* "track_line_filter.pyx":42
 * 
 *         correction = threshold * i
 *         i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 *             c += 1
 */
    __pyx_t_19 = __pyx_memoryview_fromslice(__pyx_v_f, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_19);
    if (likely(PyList_CheckExact(__pyx_t_19)) || PyTuple_CheckExact(__pyx_t_19)) {
      __pyx_t_21 = __pyx_t_19; __Pyx_INCREF(__pyx_t_21); __pyx_t_25 = 0;
      __pyx_t_26 = NULL;
    } else {
      __pyx_t_25 = -1; __pyx_t_21 = PyObject_GetIter(__pyx_t_19); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 45, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_21);
      __pyx_t_26 = Py_TYPE(__pyx_t_21)->tp_iternext; if (unlikely(!__pyx_t_26)) __PYX_ERR(0, 45, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
    for (;;) {
      if (likely(!__pyx_t_26)) {
        if (likely(PyList_CheckExact(__pyx_t_21))) {
          ...
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_19 = PyList_GET_ITEM(__pyx_t_21, __pyx_t_25); __Pyx_INCREF(__pyx_t_19); __pyx_t_25++; if (unlikely(0 < 0)) __PYX_ERR(0, 45, __pyx_L1_error)
          #else
          __pyx_t_19 = PySequence_ITEM(__pyx_t_21, __pyx_t_25); __pyx_t_25++; if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 45, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_19);
          #endif
        } else {
          if (__pyx_t_25 >= PyTuple_GET_SIZE(__pyx_t_21)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_19 = PyTuple_GET_ITEM(__pyx_t_21, __pyx_t_25); __Pyx_INCREF(__pyx_t_19); __pyx_t_25++; if (unlikely(0 < 0)) __PYX_ERR(0, 45, __pyx_L1_error)
          #else
          __pyx_t_19 = PySequence_ITEM(__pyx_t_21, __pyx_t_25); __pyx_t_25++; if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 45, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_19);
          #endif
        ...
        __pyx_t_19 = __pyx_t_26(__pyx_t_21);
        if (unlikely(!__pyx_t_19)) {
          PyObject* exc_type = PyErr_Occurred();
          if (exc_type) {
            if (likely(__Pyx_PyErr_GivenExceptionMatches(exc_type, PyExc_StopIteration))) PyErr_Clear();
      ...
      __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_char(__pyx_t_19, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 45, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
 ...
 *         c = 0
 */
      __Pyx_GetModuleGlobalName(__pyx_t_18, __pyx_n_s_np); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_18);
      __pyx_t_16 = __Pyx_PyObject_GetAttrStr(__pyx_t_18, __pyx_n_s_sum); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
      __pyx_t_18 = __pyx_memoryview_fromslice(__pyx_v_rows, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_18);
      __pyx_t_20 = NULL;
      ...
      __pyx_t_19 = (__pyx_t_20) ? __Pyx_PyObject_Call2Args(__pyx_t_16, __pyx_t_20, __pyx_t_18) : __Pyx_PyObject_CallOneArg(__pyx_t_16, __pyx_t_18);
      __Pyx_XDECREF(__pyx_t_20); __pyx_t_20 = 0;
      __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
      if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_19);
      __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
      __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_t_19); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
      __pyx_t_27 = __pyx_v_c;
      __pyx_t_5 = -1;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_v_row_sum.shape[0];
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_5 = 0;
      } else if (unlikely(__pyx_t_27 >= __pyx_v_row_sum.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 46, __pyx_L1_error)
      }
      *((float *) ( /* dim=0 */ (__pyx_v_row_sum.data + __pyx_t_27 * __pyx_v_row_sum.strides[0]) )) = ((int)__pyx_t_2);

      /* "track_line_filter.pyx":47
 *         for rows in f:
 *             row_sum[c] = <int> np.sum(rows)
 *             c += 1             # <<<<<<<<<<<<<<
 *         c = 0
 ...
 */
    ...
    if (unlikely(__pyx_memslice_transpose(&__pyx_t_1) == 0)) __PYX_ERR(0, 49, __pyx_L1_error)
    __pyx_t_21 = __pyx_memoryview_fromslice(__pyx_t_1, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 49, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_21);
    __PYX_XDEC_MEMVIEW(&__pyx_t_1, 1);
    __pyx_t_1.memview = NULL;
    __pyx_t_1.data = NULL;
    if (likely(PyList_CheckExact(__pyx_t_21)) || PyTuple_CheckExact(__pyx_t_21)) {
      __pyx_t_19 = __pyx_t_21; __Pyx_INCREF(__pyx_t_19); __pyx_t_25 = 0;
      __pyx_t_26 = NULL;
    } else {
      __pyx_t_25 = -1; __pyx_t_19 = PyObject_GetIter(__pyx_t_21); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 49, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_19);
      __pyx_t_26 = Py_TYPE(__pyx_t_19)->tp_iternext; if (unlikely(!__pyx_t_26)) __PYX_ERR(0, 49, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
    for (;;) {
      if (likely(!__pyx_t_26)) {
        if (likely(PyList_CheckExact(__pyx_t_19))) {
          ...
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_21 = PyList_GET_ITEM(__pyx_t_19, __pyx_t_25); __Pyx_INCREF(__pyx_t_21); __pyx_t_25++; if (unlikely(0 < 0)) __PYX_ERR(0, 49, __pyx_L1_error)
          #else
          __pyx_t_21 = PySequence_ITEM(__pyx_t_19, __pyx_t_25); __pyx_t_25++; if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 49, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_21);
          #endif
        } else {
          if (__pyx_t_25 >= PyTuple_GET_SIZE(__pyx_t_19)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_21 = PyTuple_GET_ITEM(__pyx_t_19, __pyx_t_25); __Pyx_INCREF(__pyx_t_21); __pyx_t_25++; if (unlikely(0 < 0)) __PYX_ERR(0, 49, __pyx_L1_error)
          #else
          __pyx_t_21 = PySequence_ITEM(__pyx_t_19, __pyx_t_25); __pyx_t_25++; if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 49, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_21);
          #endif
        ...
        __pyx_t_21 = __pyx_t_26(__pyx_t_19);
      ...
      __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_char(__pyx_t_21, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 49, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
 ...
 *         c = 0
 */
      __Pyx_GetModuleGlobalName(__pyx_t_16, __pyx_n_s_np); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 50, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __pyx_t_18 = __Pyx_PyObject_GetAttrStr(__pyx_t_16, __pyx_n_s_sum); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 50, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_18);
      __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
      __pyx_t_16 = __pyx_memoryview_fromslice(__pyx_v_columns, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 50, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __pyx_t_20 = NULL;
      if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_18))) {
        __pyx_t_20 = PyMethod_GET_SELF(__pyx_t_18);
      ...
      __pyx_t_21 = (__pyx_t_20) ? __Pyx_PyObject_Call2Args(__pyx_t_18, __pyx_t_20, __pyx_t_16) : __Pyx_PyObject_CallOneArg(__pyx_t_18, __pyx_t_16);
      __Pyx_XDECREF(__pyx_t_20); __pyx_t_20 = 0;
      __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
      if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 50, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_21);
      __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
      __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_t_21); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
      __pyx_t_28 = __pyx_v_c;
      __pyx_t_5 = -1;
      if (__pyx_t_28 < 0) {
        __pyx_t_28 += __pyx_v_column_sum.shape[0];
        if (unlikely(__pyx_t_28 < 0)) __pyx_t_5 = 0;
      } else if (unlikely(__pyx_t_28 >= __pyx_v_column_sum.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 50, __pyx_L1_error)
      }
      *((float *) ( /* dim=0 */ (__pyx_v_column_sum.data + __pyx_t_28 * __pyx_v_column_sum.strides[0]) )) = ((int)__pyx_t_2);

      /* "track_line_filter.pyx":51
 *         for columns in f.T:
 *             column_sum[c] = <int> np.sum(columns)
 *             c += 1             # <<<<<<<<<<<<<<
 *         c = 0
 ...
 */
    __pyx_t_2 = __pyx_v_y_size;
    __pyx_t_5 = __pyx_t_2;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_row = __pyx_t_6;

      /* "track_line_filter.pyx":56
 *         # Scanning for lines
 *         for row in range(0, y_size):
 *             for column in range(0, threshold):             # <<<<<<<<<<<<<<
 *                 # General matrix column position from relative f column position
 ...
 */
      __pyx_t_7 = __pyx_v_threshold;
      __pyx_t_8 = __pyx_t_7;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_v_column = __pyx_t_9;

        /* "track_line_filter.pyx":58
 *             for column in range(0, threshold):
 *                 # General matrix column position from relative f column position
 *                 general_column = column + correction             # <<<<<<<<<<<<<<
 *                 # is linear
 ...
 */
        __pyx_v_general_column = (__pyx_v_column + __pyx_v_correction);

        /* "track_line_filter.pyx":60
 *                 general_column = column + correction
 *                 # is linear
 *                 if row_sum[row] != 0 and (<float> f[row][column] * column_sum[column] / row_sum[row]) > (tolerance):             # <<<<<<<<<<<<<<
 ...
 */
        ...
        __pyx_t_12 = -1;
        if (__pyx_t_29 < 0) {
          __pyx_t_29 += __pyx_v_row_sum.shape[0];
          if (unlikely(__pyx_t_29 < 0)) __pyx_t_12 = 0;
        } else if (unlikely(__pyx_t_29 >= __pyx_v_row_sum.shape[0])) __pyx_t_12 = 0;
        if (unlikely(__pyx_t_12 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_12);
          __PYX_ERR(0, 60, __pyx_L1_error)
        }
        __pyx_t_30 = (((*((float *) ( /* dim=0 */ (__pyx_v_row_sum.data + __pyx_t_29 * __pyx_v_row_sum.strides[0]) ))) != 0.0) != 0);
        if (__pyx_t_30) {
        } else {
        ...
        __pyx_t_32 = __pyx_v_column;
        __pyx_t_12 = -1;
        if (__pyx_t_31 < 0) {
          __pyx_t_31 += __pyx_v_f.shape[0];
          if (unlikely(__pyx_t_31 < 0)) __pyx_t_12 = 0;
        } else if (unlikely(__pyx_t_31 >= __pyx_v_f.shape[0])) __pyx_t_12 = 0;
        if (__pyx_t_32 < 0) {
          __pyx_t_32 += __pyx_v_f.shape[1];
          if (unlikely(__pyx_t_32 < 0)) __pyx_t_12 = 1;
        } else if (unlikely(__pyx_t_32 >= __pyx_v_f.shape[1])) __pyx_t_12 = 1;
        if (unlikely(__pyx_t_12 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_12);
          __PYX_ERR(0, 60, __pyx_L1_error)
        }
        __pyx_t_33 = __pyx_v_column;
        __pyx_t_12 = -1;
        if (__pyx_t_33 < 0) {
          __pyx_t_33 += __pyx_v_column_sum.shape[0];
          if (unlikely(__pyx_t_33 < 0)) __pyx_t_12 = 0;
        } else if (unlikely(__pyx_t_33 >= __pyx_v_column_sum.shape[0])) __pyx_t_12 = 0;
        if (unlikely(__pyx_t_12 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_12);
          __PYX_ERR(0, 60, __pyx_L1_error)
        }
        __pyx_t_34 = (((float)(*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_31 * __pyx_v_f.strides[0]) ) + __pyx_t_32 * __pyx_v_f.strides[1]) )))) * (*((float *) ( /* dim=0 */ (__pyx_v_column_sum.data + __pyx_t_33 * __pyx_v_column_sum.strides[0]) ))));
        __pyx_t_35 = __pyx_v_row;
        __pyx_t_12 = -1;
        if (__pyx_t_35 < 0) {
          __pyx_t_35 += __pyx_v_row_sum.shape[0];
          if (unlikely(__pyx_t_35 < 0)) __pyx_t_12 = 0;
        } else if (unlikely(__pyx_t_35 >= __pyx_v_row_sum.shape[0])) __pyx_t_12 = 0;
        if (unlikely(__pyx_t_12 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_12);
          __PYX_ERR(0, 60, __pyx_L1_error)
        }
        __pyx_t_36 = (*((float *) ( /* dim=0 */ (__pyx_v_row_sum.data + __pyx_t_35 * __pyx_v_row_sum.strides[0]) )));
        if (unlikely(__pyx_t_36 == 0)) {
          PyErr_SetString(PyExc_ZeroDivisionError, "float division");
          __PYX_ERR(0, 60, __pyx_L1_error)
        }
        __pyx_t_30 = (((__pyx_t_34 / __pyx_t_36) > __pyx_v_tolerance) != 0);
        __pyx_t_13 = __pyx_t_30;
        __pyx_L19_bool_binop_done:;
        if (__pyx_t_13) {

          /* "track_line_filter.pyx":61
 *                 # is linear
 *                 if row_sum[row] != 0 and (<float> f[row][column] * column_sum[column] / row_sum[row]) > (tolerance):
 *                     cut_frame[row][general_column] = 255             # <<<<<<<<<<<<<<
 *                     points.append([general_column, x_size - row])
 *                 # is not
 */
          __pyx_t_37 = __pyx_v_row;
          __pyx_t_38 = __pyx_v_general_column;
          __pyx_t_12 = -1;
          if (__pyx_t_37 < 0) {
            __pyx_t_37 += __pyx_v_cut_frame.shape[0];
            if (unlikely(__pyx_t_37 < 0)) __pyx_t_12 = 0;
          } else if (unlikely(__pyx_t_37 >= __pyx_v_cut_frame.shape[0])) __pyx_t_12 = 0;
          if (__pyx_t_38 < 0) {
            __pyx_t_38 += __pyx_v_cut_frame.shape[1];
            if (unlikely(__pyx_t_38 < 0)) __pyx_t_12 = 1;
          } else if (unlikely(__pyx_t_38 >= __pyx_v_cut_frame.shape[1])) __pyx_t_12 = 1;
          if (unlikely(__pyx_t_12 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_12);
            __PYX_ERR(0, 61, __pyx_L1_error)
          }
          *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_cut_frame.data + __pyx_t_37 * __pyx_v_cut_frame.strides[0]) ) + __pyx_t_38 * __pyx_v_cut_frame.strides[1]) )) = 0xFF;

          /* "track_line_filter.pyx":62
 *                 if row_sum[row] != 0 and (<float> f[row][column] * column_sum[column] / row_sum[row]) > (tolerance):
 *                     cut_frame[row][general_column] = 255
 *                     points.append([general_column, x_size - row])             # <<<<<<<<<<<<<<
 *                 # is not
 *                 else:
 */
          __pyx_t_19 = __Pyx_PyInt_From_int(__pyx_v_general_column); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 62, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_19);
          __pyx_t_21 = __Pyx_PyInt_From_int((__pyx_v_x_size - __pyx_v_row)); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 62, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_21);
          ...
          __Pyx_GIVEREF(__pyx_t_21);
          PyList_SET_ITEM(__pyx_t_18, 1, __pyx_t_21);
          __pyx_t_19 = 0;
          __pyx_t_21 = 0;
          __pyx_t_39 = __Pyx_PyList_Append(__pyx_v_points, __pyx_t_18); if (unlikely(__pyx_t_39 == ((int)-1))) __PYX_ERR(0, 62, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
 ...
 */
        /*else*/ {
          ...
          __pyx_t_41 = __pyx_v_general_column;
          __pyx_t_12 = -1;
          if (__pyx_t_40 < 0) {
            __pyx_t_40 += __pyx_v_cut_frame.shape[0];
            if (unlikely(__pyx_t_40 < 0)) __pyx_t_12 = 0;
          } else if (unlikely(__pyx_t_40 >= __pyx_v_cut_frame.shape[0])) __pyx_t_12 = 0;
          if (__pyx_t_41 < 0) {
            __pyx_t_41 += __pyx_v_cut_frame.shape[1];
            if (unlikely(__pyx_t_41 < 0)) __pyx_t_12 = 1;
          } else if (unlikely(__pyx_t_41 >= __pyx_v_cut_frame.shape[1])) __pyx_t_12 = 1;
          if (unlikely(__pyx_t_12 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_12);
            __PYX_ERR(0, 65, __pyx_L1_error)
          }
          *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_cut_frame.data + __pyx_t_40 * __pyx_v_cut_frame.strides[0]) ) + __pyx_t_41 * __pyx_v_cut_frame.strides[1]) )) = 0;
        }
        __pyx_L18:;
      }
    }

    /* "track_line_filter.pyx":67
 *                     cut_frame[row][general_column] = 0
 * 
 *         row_sum[:] = 0             # <<<<<<<<<<<<<<
 *         column_sum[:] = 0
 ...
 */
    {
        ...
        {
            Py_ssize_t __pyx_temp_extent_0 = __pyx_v_row_sum.shape[0];
            Py_ssize_t __pyx_temp_stride_0 = __pyx_v_row_sum.strides[0];
            char *__pyx_temp_pointer_0;
            Py_ssize_t __pyx_temp_idx_0;
            __pyx_temp_pointer_0 = __pyx_v_row_sum.data;
 ...
 */
    {
        float __pyx_temp_scalar = 0.0;
        {
            Py_ssize_t __pyx_temp_extent_0 = __pyx_v_column_sum.shape[0];
            Py_ssize_t __pyx_temp_stride_0 = __pyx_v_column_sum.strides[0];
            char *__pyx_temp_pointer_0;
            Py_ssize_t __pyx_temp_idx_0;
            __pyx_temp_pointer_0 = __pyx_v_column_sum.data;
            for (__pyx_temp_idx_0 = 0; __pyx_temp_idx_0 < __pyx_temp_extent_0; __pyx_temp_idx_0++) {
              *((float *) __pyx_temp_pointer_0) = __pyx_temp_scalar;
              __pyx_temp_pointer_0 += __pyx_temp_stride_0;
            }
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_f, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_row_sum, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_column_sum, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_rows, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_columns, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_17track_line_filter_1find_lines(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_17track_line_filter_1find_lines(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_edges_frame = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_edges_frame,&__pyx_n_s_threshold,&__pyx_n_s_tolerance,&__pyx_n_s_cut,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_edges_frame)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_threshold)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("find_lines", 1, 4, 4, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_tolerance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("find_lines", 1, 4, 4, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cut)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("find_lines", 1, 4, 4, 3); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "find_lines") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_edges_frame = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_edges_frame.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_threshold = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_threshold == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_tolerance = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_tolerance == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_cut = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_cut == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("find_lines", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("track_line_filter.find_lines", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_17track_line_filter_find_lines(__pyx_self, __pyx_v_edges_frame, __pyx_v_threshold, __pyx_v_tolerance, __pyx_v_cut);
...
static PyObject *__pyx_pf_17track_line_filter_find_lines(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_edges_frame, int __pyx_v_threshold, float __pyx_v_tolerance, int __pyx_v_cut) {
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_edges_frame, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "track_line_filter.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "track_line_filter.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "track_line_filter.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "track_line_filter._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"find_lines", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_17track_line_filter_1find_lines, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_track_line_filter(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_track_line_filter},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_edges_frame, __pyx_k_edges_frame, sizeof(__pyx_k_edges_frame), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC inittrack_line_filter(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC inittrack_line_filter(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_track_line_filter(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_track_line_filter(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_track_line_filter(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'track_line_filter' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_track_line_filter(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("track_line_filter", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_track_line_filter) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "track_line_filter")) {
      if (unlikely(PyDict_SetItemString(modules, "track_line_filter", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init track_line_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init track_line_filter");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
